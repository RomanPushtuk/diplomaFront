                    ...
                    <div className="page-next-level">
                      ...
                      <ul className="list-unstyled mt-4">
                        <li className="list-inline-item h6 user text-muted mr-2">
                          <i className="mdi mdi-account" /> Calvin Carlo
                        </li>
                        <li className="list-inline-item h6 date text-muted">
                          <i className="mdi mdi-calendar-check" /> 13th August,
                          2019
                        </li>
                      </ul>
                        ...
                        <div className="blog position-relative overflow-hidden shadow rounded bg-light">
                          ...
                          <div className="author">
                            ...
                            <small className="text-light date">
                              <i className="mdi mdi-calendar-check" /> 13th
                              August, 2019
                            </small>
                          </div>
                        </div>
